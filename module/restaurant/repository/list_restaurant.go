...
func NewListRestaurantRepo(store ListRestaurantStore) *listRestaurantRepo { // *deleteRestaurantBiz: return con trỏ *deleteRestaurantBiz
	return &listRestaurantRepo{store: store} // bắt buộc phải có &
}
